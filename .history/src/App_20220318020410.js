...
function App () {
  return (
    <div className="root">
      ...
      <div className="d-flex align-content-center" data-bss-parallax-bg="true" id="intro-section" style={{ backgroundImage: 'url(' + 'assets/img/bg1.jpg' + ')' }} >
          ...
          <section className="d-flex d-lg-flex align-items-lg-center faq-section">
              <div className="container-md d-flex flex-column">
                  ...
                  <div className="align-items-start justify-content-center row row-cols-1 row-cols-lg-3 row-cols-md-2 row-cols-sm-1 row-cols-xl-3 row-cols-xxl-3">
                      <div className="col">
                          <div className="card-container grow text-center"><i className="fas fa-basketball-ball card-icon"></i>
                      ...
                      <div className="col">
                          <div className="text-center card-container grow"><i className="fas fa-basketball-ball card-icon"></i>
                              <div className="card-outer">
                                  <div className="text-center card-inner">
                          ...
                          <div className="text-center card-container grow"><i className="fas fa-basketball-ball card-icon"></i>
                              <div className="card-outer">
                                  <div className="text-center card-inner">
                                      ...
                                      <p>You can mint <a href="https://in-the-game-client-staging.herokuapp.com/">here</a>.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
        ...
        <footer className="footer-dark">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col item social"><a className="social-icons" href="#"><i className="icon ion-social-facebook"></i></a><a className="social-icons" href="#"><i className="icon ion-social-twitter"></i></a><a className="social-icons" href="#"><i className="icon ion-social-snapchat"></i></a><a className="social-icons" href="#"><i className="icon ion-social-instagram"></i></a>
                        </div>
                    </div>
